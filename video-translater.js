...
// @resource         styles https://raw.githubusercontent.com/enotgr/voice-over-translation/master/styles.css
// @grant            GM_getResourceText
// @grant            GM_addStyle
// @grant            GM_xmlhttpRequest
// @grant            GM_info
// @updateURL        https://raw.githubusercontent.com/enotgr/voice-over-translation/master/vot.user.js
// @downloadURL      https://raw.githubusercontent.com/enotgr/voice-over-translation/master/vot.user.js
// @supportURL       https://github.com/enotgr/voice-over-translation/issues
// @homepageURL      https://github.com/enotgr/voice-over-translation
...
if (!USOV4.includes(GM_info.scriptHandler)) {
  ...
  fetch('https://raw.githubusercontent.com/enotgr/voice-over-translation/master/styles.css')
  ...
  <div class = "translationBlock">
      <span class = "translationArea" role = "button">
          <span class = "translationIAlice" tabindex = "-1">
              <img class = "translationImageAlice" src = "https://raw.githubusercontent.com/enotgr/voice-over-translation/master/img/YAlice.svg">
          </span>
...
$("body").on("yt-page-data-updated", async function () {
  ...
  function changeBackgroundError() {
    $translationImageAlice.attr('src', 'https://raw.githubusercontent.com/enotgr/voice-over-translation/master/img/YAliceError.svg')
  ...
  function changeBackgroundSuccess() {
    $translationImageAlice.attr('src', 'https://raw.githubusercontent.com/enotgr/voice-over-translation/master/img/YAlice.svg')
